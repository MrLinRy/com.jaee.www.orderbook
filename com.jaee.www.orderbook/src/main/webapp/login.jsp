        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="${pageContext.request.contextPath}/login" method="post">
                        <fieldset>
                           <input type="hidden" class="form-control" value = "supplier" name="username" autofocus>
                            <input type="hidden" class="form-control" value = "123456" placeholder="密码" name="password" type="password">
                            <!-- Change this to a button or input when using this as a form -->
                            <input type="submit" value="游客" class="form-control">
                        </fieldset>
                    </form>
                </div>
            </div>
